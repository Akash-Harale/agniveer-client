    ...
    <>
      ...
      <div className="top-bar">
        ...
        <div className="right-icons">
          <a href="#maincontent" className="top-link skip-link">
            Skip to main content
          </a>
          <span className="separator">|</span>
          <a href="#" className="top-link" aria-label="Increase font size">
            A+
          </a>
          <a href="#" className="top-link" aria-label="Normal font size">
            A
          </a>
          <a href="#" className="top-link" aria-label="Decrease font size">
            A-
          </a>
          <span className="separator">|</span>
        ...
        <div className="header-left">
          ...
          <div>
            ...
            <h2 className="english-title">
              MINISTRY OF <br></br> <span className="home-affairs">HOME AFFAIRS</span>
            </h2>
          </div>
        </div>
